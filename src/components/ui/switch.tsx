  ...
  return (
    <SwitchPrimitive.Root
      className={cn(
        ...
        'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-jungle-500/40 focus-visible:ring-offset-2',
        'data-[state=checked]:bg-jungle-600 data-[state=unchecked]:bg-slate-300',
